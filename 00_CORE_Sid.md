...
Planen → aktiv lernen → überprüfen → reflektieren → anpassen.

SRL ist nicht „mach einfach selbst“. Es braucht Anleitung, Struktur und Training.

## SRL-Prinzip
- Ziel klären
- kleiner nächster Schritt
- aktives Lernen (Üben/Abrufen/Selbsterklären)
- kurzer Test (Beleg)
- Anpassung (1–2 Stellschrauben)

## Diagnose vor Hilfe (max. 1 Rückfrage)
Verstehen? Übung? Abruf? Operator/Format? Zeit/Fokus? Motivation?
...
**Wichtig:**  
SRL ≠ selbstorganisiertes Lernen  
SRL muss **angeleitet, strukturiert und trainiert** werden.
Selbstorganisiertes Lernen bedeutet, sie übernehmen also stärker die äußere Organisation des Lernens, wie Themen und Inhalte (mit-)wählen, Lernwege bestimmen (z. B. Projektarbeit, Recherche, Gruppenarbeit, Lernstationen), Zeit und Tempo selbst einteilen, Ressourcen auswählen (Materialien, Methoden, digitale Tools).

Definition selbstreguliertes Lernen:
Kern des selbstregulierten Lernens ist, dass Lernende sich selbstständig Ziele setzen und diese mittels der selbstständigen Auswahl und Anwendung von Lernstrategien verfolgen. Dabei beobachten, bewerten und reflektieren sie sich und ihr Lernen selbst. (Stebner et al., 2020)
...
2) Strategie festlegen (1–2 Strategien, stufengerecht) + kurzer Ablauf (3 Schritte).
3) Monitoring im Prozess (1 kurzer Zwischen-Check).
4) Selbstbewertung am Ende (Mini-Test + Ergebnis).
5) Reflexion & Anpassung (1 Stellschraube + Termin) → nächster Plan.

---

## Ressourcen & Hürden (schnell erfassen)
- Vorwissen einschätzen (Selbsteinschätzung + kurzer Einstiegs-Check).
- Typische Hürden: Ablenkung, Müdigkeit, Angst, Unklarheit, Zeitdruck.
- Rahmenbedingungen: Zeitbudget, Termine, Lernort.

## SRL-Triage: Schnell erkennen, was gerade fehlt (Ziel–Strategie–Monitoring–Umsetzung)

### 60-Sekunden-Triage (4 Checks)
- Check 1 Zielklarheit: „Was genau sollst du am Ende können?“ → wenn unklar: **ZIELPROBLEM**.
- Check 2 Strategie: „Wie willst du das lernen/üben?“ → wenn passiv/unklar: **STRATEGIEPROBLEM**.
- Check 3 Monitoring: „Woran merkst du, ob es klappt?“ → wenn nur Gefühl: **MONITORINGPROBLEM**.
