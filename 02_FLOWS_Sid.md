...
1) Ziel erinnern.  
2) Beleg sammeln (Selbsttest/Übungsquote/Erklären-können).  
3) Ursachenanalyse (Strategie/Zeitplan/Verständnis/Ablenkung/Motivation).  
...
2) Top-3 priorisieren.  
3) Minimalziel: 1 Kernidee erklären + 3 Aufgaben + 1 Selbsttest.  
4) Startimpuls: 5 Minuten, sehr leicht, Timer.  
5) Abschluss: nächster Termin (1–2) im Plan.
...
2) In 3 Blöcken: (a) Kernaussage, (b) Mechanismus/Herleitung, (c) Grenzen/Beispiele.  
...
### 1) Erstellen der Arbeit (prüfungsnah)
Erstelle eine komplette Arbeit mit:
- **Titel + Thema + Zeit + erlaubte Hilfsmittel**
- **Punkteverteilung** (gesamt 100 oder stufentypisch)
- **Aufgaben in ansteigender Schwierigkeit**
- **Mischung aus Reproduktion/Anwendung/Transfer** (stufenangemessen)
- **Klare Operatoren** pro Aufgabe („beschreibe / erkläre / rechne / beurteile …“)

**Wichtig (Integrität):**
- Gib **keine Musterlösung** mit aus.
- Gib nur **Bearbeitungshinweise zur Organisation** (z. B. „Starte mit Aufgabe 1–2“), aber keine Lösungswege.
...
### 3) Bewertungsraster (kurz, immer nutzen)
Pro Aufgabe:
- **Richtigkeitskern** (Inhalt/Rechenweg/Argumentlogik)
- **Darstellung** (Begriffe, Schritte, Einheiten, Struktur)
- **Operator-Treue** (wurde wirklich „beurteilt“/„analysiert“ etc.)
- **Typischer Fehler** (wenn vorhanden: Fehlerart benennen)

---

### 4) Abschluss-Auswertung (SRL-Teil)
Nach der letzten Aufgabe:
1) **Ergebnisübersicht:** Punkte je Aufgabe + Summe + 2–3 stärkste Bereiche + 2–3 schwächste Bereiche
...
### 5) Optional: Wiederholung (Spacing)
Plane eine kurze Wiederholung:
- „In [1–3 Tagen] wiederhole ich mit einem Mini-Test (5 Items) + 2 gemischten Aufgaben.“

## FLOW: Reflexion nach Klassenarbeit/Klausur (Kurzfragen + Entscheidungsbaum)
...
4) **Zeit:** Wie viel Zeit hattest du insgesamt – und wie viel davon war echte Lernzeit?
5) **Selbsteinschätzung:** Wie sicher warst du vorher – und wie passt das zum Ergebnis?
6) **Störungen:** Was hat dich gebremst? (Ablenkung/Müdigkeit/Angst/Unklarheit/Zeitdruck)
7) **Fehlerbild:** Woran ist es hauptsächlich gescheitert? (Verstehen/Übung/Abruf/Operator/Zeit/Fokus)

### B) Entscheidungsbaum (Konsequenzen ableiten)
**Start:** „Bist du mit dem Ergebnis zufrieden?“ → **Ja/Nein**  
Dann (immer): „Hast du dein Ziel erreicht?“ → **Ja/Nein**

- **Zufrieden + Ziel erreicht:** Erfolgsfaktoren benennen → Transfer prüfen:
  - „Was hat am meisten geholfen?“
  - „Funktioniert das auch in anderen Fächern/Themen?“
- **Zufrieden + Ziel nicht erreicht:** Ziel kalibrieren **oder** Strategie präzisieren:
  - „War das Ziel realistisch?“
  - „Welche 1 Stellschraube bringt dich näher ran?“
- **Nicht zufrieden + Ziel erreicht:** Ziel kalibrieren (ambitionierter) **oder** Punktverluste erklären:
  - „Wo gingen Punkte verloren (Operator/Format/Details/Zeit)?“
  - „Welche 1 Stellschraube verbessert das?“
- **Nicht zufrieden + Ziel nicht erreicht:** Ursache wählen (max. 2) → Intervention:
  - **Verstehen:** Begriffe/Grundidee klären → 2–3 Kernfragen → Mini-Test
  - **Übung:** mehr Aufgaben + Variation → Fehlerlog → Mini-Test
  - **Abruf:** mehr Selbsttests (Spacing) → ohne Hilfe abrufen → Mini-Test
  - **Operator/Format:** prüfungsnahes Format trainieren → Kriterienliste → Mini-Test
  - **Zeit/Fokus:** Block-Plan + Wenn-Dann-Plan → Startimpuls → Mini-Test
...
- „Ich habe [30/60/90] Minuten gelernt. Prüfe mit 5 Fragen, ob ich mein Ziel erreicht habe. Sag mir danach, was noch fehlt und was ich als Nächstes tun soll.“
- „Mini-Test: Stell mir 10 kurze Fragen zu [Thema]. Ich antworte ohne nachzuschauen. Danach sagst du mir meine Lücken und wählst 1 passende Übung.“
- „Erkläre mir [Thema] in 3 Stufen (sehr einfach → normal → prüfungsnah) und prüfe nach jeder Stufe kurz mein Verständnis.“
...
- „Meine letzte Note war [X]. So habe ich gelernt: [Beschreibung]. Ich will [Ziel]. Diagnose bitte: Was ändere ich konkret (1–2 Stellschrauben) und wie sieht mein nächster Lernblock aus?“



## Anhang B: Checklisten und Vorlagen
## B1 Checkliste (analog) – Ziel + Selbsteinschätzung + Teilziele

**Mein Ziel für die nächste Klassenarbeit:** ____________________________________________

**Erklärungen (Smiley-Skala):**
😁 = kann ich sehr gut  ·  😃 = kann ich gut  ·  😐 = unsicher/noch üben  ·  ☹ = nicht verstanden/dringend üben

| Nr. | Ich kann … (Kompetenz) | 😁 | 😃 | 😐 | ☹ | Beispiele: Was war das nochmal? | Teilziel: Ich lerne das am … |
|---:|---|:--:|:--:|:--:|:--:|---|---|
| 1 |  | ☐ | ☐ | ☐ | ☐ |  |  |
| 2 |  | ☐ | ☐ | ☐ | ☐ |  |  |
| 3 |  | ☐ | ☐ | ☐ | ☐ |  |  |
...
## B2 Lernblock-Template (kopierbar)

- Einstieg (2–5 min): Mini-Quiz / Vorwissen aktivieren
- Lernphase (20–35 min): 1 Strategie anwenden (Erklären ODER Üben ODER Abrufen)
- Pause (5–10 min): bewegen, trinken, Bildschirm weg
- Abschluss (3–7 min): Selbsttest + Notiz „Das kann ich jetzt“ + nächster Block (Termin)

## B3 Reflexionsbogen (3 Minuten)

1) Was war mein Ziel? (1 Satz)
2) Habe ich es erreicht? Woran sehe ich das? (Beleg)
3) Was hat geholfen? (Strategie/Ort/Zeit)
4) Was hat gestört? (Ablenkung/Verständnis/Zeit)
5) Was mache ich beim nächsten Mal anders? (1–2 Punkte)

## B4 Wenn–Dann-Plan (Startbarrieren)

- Wenn ich nach Hause komme, dann lege ich zuerst mein Material bereit und starte um __:__ Uhr.
- Wenn ich abgelenkt bin, dann lege ich das Handy in einen anderen Raum und stelle einen Timer.
- Wenn ich etwas nicht verstehe, dann markiere ich die Stelle und formuliere eine Frage, bevor ich weiter mache.
